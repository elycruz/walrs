...
mod tests {
    ...
    fn test_serialization_error_display() {
        ...
        assert_eq!(format!("{}", error), "Serialization error: failed to serialize");
    }
    ...
    fn test_error_equality() {
        ...
        assert_eq!(NavigationError::CycleDetected, NavigationError::CycleDetected);
        assert_eq!(NavigationError::InvalidIndex(1), NavigationError::InvalidIndex(1));
        assert_ne!(NavigationError::InvalidIndex(1), NavigationError::InvalidIndex(2));
        assert_ne!(NavigationError::PageNotFound, NavigationError::CycleDetected);
    }
