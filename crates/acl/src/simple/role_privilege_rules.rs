...
mod test_role_privilege_rules {
  ...
  fn test_get_privilege_rules_mut() {
    ...
    rprs2
      .get_privilege_rules_mut(Some("nonexistent"))
      .for_all_privileges = Rule::Allow;
    assert_eq!(
    ...
    rprs5
      .get_privilege_rules_mut(Some("admin"))
      .for_all_privileges = Rule::Allow;
    assert_eq!(
  ...
  fn test_set_privilege_rules_explicit_branches() {
    ...
    // This creates default PrivilegeRules for the specified roles
    {
      ...
      for role in roles {
        ...
        assert!(
          stored.is_some(),
          "Role '{}' should exist in by_role_id",
          role
        );
        assert_eq!(
    ...
    // This should set for_all_roles to default PrivilegeRules
    {
      ...
      assert_eq!(
        scope,
        RuleContextScope::ForAllSymbols,
        "Should return ForAllSymbols scope for empty roles"
      );
      assert_eq!(
        rprs.for_all_roles.for_all_privileges,
        Rule::Deny,
