...
fn main() -> Result<(), String> {
  ...
  println!(
    "  Can read public: {}",
    acl.is_allowed(Some("guest"), Some("public"), Some("read"))
  );
  println!(
    "  Can read blog: {}",
  ...
  println!(
    "  Can comment on blog: {}",
    acl.is_allowed(Some("user"), Some("blog"), Some("comment"))
  );
  println!(
    "  Can write blog: {}",
  ...
  println!(
    "  Can read blog: {}",
    acl.is_allowed(Some("editor"), Some("blog"), Some("read"))
  );
  println!(
    "  Can write blog: {}",
    acl.is_allowed(Some("editor"), Some("blog"), Some("write"))
  );
  println!(
    "  Can edit blog: {}",
    acl.is_allowed(Some("editor"), Some("blog"), Some("edit"))
  );
  println!(
    "  Can access admin panel: {}",
    acl.is_allowed(Some("editor"), Some("admin_panel"), Some("read"))
  );
  println!();
  ...
  println!(
    "  Can delete blog: {}",
    acl.is_allowed(Some("admin"), Some("blog"), Some("delete"))
  );
  println!(
    "  Can access admin panel: {}",
  ...
  println!(
    "  Can manage admin panel: {}",
    acl.is_allowed(Some("admin"), Some("admin_panel"), Some("manage"))
  );
  println!();
  ...
  println!(
    "  admin inherits from guest (transitive): {}",
