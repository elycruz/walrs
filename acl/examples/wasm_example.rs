...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   - Guest can read blog: {}", acl.is_allowed(Some("guest"), Some("blog"), Some("read")));
    println!("   - User can write blog: {}", acl.is_allowed(Some("user"), Some("blog"), Some("write")));
    println!("   - User can access admin_panel: {}", acl.is_allowed(Some("user"), Some("admin_panel"), Some("read")));
    println!("   - Admin can access admin_panel: {}", acl.is_allowed(Some("admin"), Some("admin_panel"), Some("read")));
  ...
  "deny": [
    ...
    println!("   - Guest can read index: {}", acl.is_allowed(Some("guest"), Some("index"), Some("read")));
    println!("   - User can write blog: {}", acl.is_allowed(Some("user"), Some("blog"), Some("write")));
    println!("   - User can publish blog: {}", acl.is_allowed(Some("user"), Some("blog"), Some("publish")));
    println!("   - Moderator can publish blog: {}", acl.is_allowed(Some("moderator"), Some("blog"), Some("publish")));
    println!("   - Moderator can delete comments: {}", acl.is_allowed(Some("moderator"), Some("comments"), Some("delete")));
    ...
    println!("   - Super admin can do anything: {}", modified_acl.is_allowed(Some("super_admin"), Some("blog"), Some("delete")));
