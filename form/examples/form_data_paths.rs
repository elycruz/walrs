...
fn main() {
    ...
    println!("  orders[0].items[0].name: {:?}", 
        data.get("orders[0].items[0].name").unwrap().as_str());
    println!("  orders[0].items[1].qty: {:?}", 
