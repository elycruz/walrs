...
fn main() {
    ...
    println!("   No contact info: {:?}", contact_filter.validate(&no_contact).is_ok());
    println!("   With email: {:?}", contact_filter.validate(&with_email).is_ok());
    println!("   With phone: {:?}", contact_filter.validate(&with_phone).is_ok());
    ...
    payment_filter.add_cross_field_rule(CrossFieldRule {
        ...
        fields: vec!["credit_card".to_string(), "paypal".to_string(), "bank_transfer".to_string()],
    ...
    println!("   One payment method: {:?}", payment_filter.validate(&one_payment).is_ok());
    println!("   Multiple payment methods: {:?}", payment_filter.validate(&multiple_payments).is_ok());
    ...
    address_filter.add_cross_field_rule(CrossFieldRule {
        ...
        fields: vec!["different_billing".to_string(), "billing_address".to_string()],
    ...
    println!("   Same address (no flag): {:?}", address_filter.validate(&same_address).is_ok());
    println!("   Different billing flag, no address: {:?}", address_filter.validate(&different_billing_no_address).is_ok());
    println!("   Different billing with address: {:?}", address_filter.validate(&different_billing_with_address).is_ok());
