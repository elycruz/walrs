...
fn main() {
    ...
    let equality_validator = EqualityValidator::<&str>::builder()
        ...
        .build()
        .unwrap();
    println!("   Validating 'hello': {:?}", equality_validator.validate("hello"));
    println!("   Validating 'world': {:?}", equality_validator.validate("world"));
    println!();
    ...
    let length_validator = LengthValidator::<str>::builder()
        ...
        .build()
        .unwrap();
    println!("   Validating 'hello': {:?}", length_validator.validate_ref("hello"));
    println!("   Validating 'hi': {:?}", length_validator.validate_ref("hi"));
    println!("   Validating 'this is too long': {:?}", length_validator.validate_ref("this is too long"));
    println!();
    ...
    let pattern_validator = PatternValidator::builder()
        ...
        .build()
        .unwrap();
    println!("   Validating 'hello': {:?}", pattern_validator.validate_ref("hello"));
    println!("   Validating '123': {:?}", pattern_validator.validate_ref("123"));
    println!("   Validating '!@#': {:?}", pattern_validator.validate_ref("!@#"));
    println!();
    ...
    let step_validator = StepValidator::<usize>::builder()
        .step(5)
        .build()
        .unwrap();
